import { formatPrice, genrateAmount } from '../utils';
...
const CartItem = ({ cartItem }) => {
  ...
  // use dispatch to pass the payload values
...
//for each cartitems props in cartitem list each cartitem is genrated
//in this we have two structure one below sm felx-col and above sm flex-row
//daisyui - bage
